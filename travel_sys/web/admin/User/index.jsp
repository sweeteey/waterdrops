...
<head>
<base href="<%=basePath%>">
<title><spring:message code="sys_name" /></title>

</head>
<body>
	<div id="dcWrap">

		<%@ include file="/admin/system/head.jsp"%>
		<%@ include file="/admin/system/menu.jsp"%>
		...
		<div id="dcMain">
			...
			<div id="index" class="mainBox"
				...
				<div class="warning">您还没有删除 install 文件夹，出于安全的考虑，我们建议您删除
					install 文件夹。</div>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="7"
										...
										<tr>
											...
											<td><strong>关闭<a href="system.php"
													class="cueRed ml">（点击开启）</a> </strong></td>
											<td>编码：</td>
					...
					<ul>
						<table width="100%" border="0" cellspacing="0" cellpadding="7"
							...
							<tr>
								...
								<td><a href="http://www.mycodes.net" target="_blank">http://www.mycodes.net</a>
								</td>
							</tr>
							<tr>
								<td>开发者社区：</td>
								<td><a href="http://www.mycodes.net" target="_blank">http://www.mycodes.net
								</a><em>（安装使用 模板交流 BUG反馈 意见建议）</em></td>
							</tr>
							<tr>
								<td>贡献者：</td>
							...
							<tr>
								<td>系统使用协议：</td>
								<td><a href="http://www.mycodes.net/license.html"
									target="_blank">http://www.mycodes.net/license.html</a><em>（您可以免费使用DouPHP（不限商用），但必须保留相关版权信息。）</em>
								</td>
							</tr>
						</table>
					</ul>
